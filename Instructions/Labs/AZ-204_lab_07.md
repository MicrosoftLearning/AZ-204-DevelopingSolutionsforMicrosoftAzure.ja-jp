...
1. **[キー コンテナーの作成]** ブレードの **[基本]** タブで、次のアクションを実行してから、**[アクセス構成]** タブを選択します。
...
1. **[アクセス構成]** タブで、アクセス許可モデルを **[コンテナーのアクセス ポリシー]** に変更します。

1. **[確認および作成]** タブを選択し、これまでの手順で選択したオプションを確認します。
...
1. [**アクセス ポリシーの作成**] ブレードで、[**アクセス許可**] セクションを選択し、次の選択を行います。
