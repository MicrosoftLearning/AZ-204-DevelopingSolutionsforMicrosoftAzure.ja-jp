...
ms.openlocfilehash: 701078a335773d2f1cd0d4ec53160fe89ecaa9a0
ms.sourcegitcommit: be44292ecbefbcb1bbf427591b34ef00a7e8c039
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/08/2022
ms.locfileid: "147519239"
---
...
1.  **[名前空間の作成]** ブレードの **[基本]** タブで、次のアクションを実行し、 **[確認および作成]** を選択します。
    ...
    | **[名前空間の名前]** テキストボックス | 「**sbnamespace** _[ご自分の名前]_ 」と入力します。 |
