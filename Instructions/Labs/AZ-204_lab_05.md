...
1. **Windows ターミナル** アプリケーションに切り替えます。
...
1. **[Cloud Shell]** ウィンドウで、アップロード/ダウンロード ボタン (右下隅の反対方向を指す 2 つの矢印が表示された折りたたまれたページで表されています) を選択し、ドロップダウン メニューで **[アップロード]** を選択します。

1. **[開く]** ダイアログ ボックスで、空の **Allfiles (F):\\Allfiles\\Labs\\05\\Starter\\func** ディレクトリに移動し、**lab05.zip** を選択して、**[開く]** を選択します。
