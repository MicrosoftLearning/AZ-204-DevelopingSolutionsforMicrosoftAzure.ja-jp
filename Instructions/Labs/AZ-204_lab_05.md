...
1.  Azure portal のナビゲーション ウィンドウで、**[リソース、サービス、ドキュメントの検索]** テキスト ボックスを使用して、「**リソース グループ**」を検索し、結果の一覧で **[リソース グループ]** を選択します。
...
1.  **[コンテナー インスタンスの作成]** ブレードで、次のアクションを実行し、 **[OK]** を選択します。
