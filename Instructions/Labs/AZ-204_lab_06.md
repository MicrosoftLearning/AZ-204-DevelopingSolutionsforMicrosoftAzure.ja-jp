...
ms.openlocfilehash: 5666555eeb731c23a962b46faecac68b30fc6c96
ms.sourcegitcommit: 137a15ca318474f0f832e5d6244f36eea35708f9
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/11/2022
ms.locfileid: "147548324"
---
...
1.  バージョンの `Microsoft.AspNetCore.Authentication.JwtBearer` と `Microsoft.AspNetCore.Authentication.OpenIdConnect` の NuGet パッケージが **6.0.6** に設定されていることを確認します。

1.  `Microsoft.Identity.Web` と `Microsoft.Identity.Web.UI` NuGet パッケージのバージョンを **1.25.0** に設定します。
